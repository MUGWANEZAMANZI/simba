...
const languages = {
  en: {
    ...
    preparing: "Preparing",
    ready: "Ready",
    // Admin / Delivery / Market labels
    deliveryPortalTitle: "Delivery Company Portal",
    refresh: "Refresh",
    logout: "Logout",
    totalLabel: "Total",
    ...
    noDeliveryOrdersFound: "No delivery orders found for this provider.",
    tableId: "ID",
    ...
    activeDeliveriesLabel: "Active Delivery",
    ...
    currentStockFor: "Current stock levels for",
    addNewProductTitle: "Add New Product",
    productNamePlaceholder: "Product Name",
    pricePlaceholder: "Price (RWF)",
    categoryPlaceholder: "Category (e.g. Food Products)",
    unitPlaceholder: "Unit (e.g. Pcs, Kg)",
    locationPlaceholder: "Location (e.g. Kigali Warehouse, Aisle 3)",
    imagePlaceholder: "Cloud image URL",
    uploadImageNote: "Upload the image to a cloud service first, then paste the public link here.",
    addingProduct: "Adding...",
    addProduct: "Add Product",
    ordersCountLabel_singular: "order",
    // Profile / Tracker / Cart
  ...
  fr: {
    ...
    ready: "Prêt",
    // Admin / Delivery / Market labels (FR)
    deliveryPortalTitle: "Portail de livraison",
    refresh: "Rafraîchir",
    logout: "Se déconnecter",
    totalLabel: "Total",
    pendingLabel: "En attente",
    assignedLabel: "Assigné",
    deliveringLabel: "En cours de livraison",
    deliveredLabel: "Livré",
    ordersToDeliver: "Commandes à livrer",
    loading: "Chargement...",
    ordersCountLabel: "commandes",
    noDeliveryOrdersFound: "Aucune commande de livraison trouvée pour ce fournisseur.",
    tableId: "ID",
    tableCustomer: "Client",
    tableAddress: "Adresse",
    tableTotal: "Total",
    tableStatus: "Statut",
    tableUpdate: "Mettre à jour",
    ...
    activeDeliveriesLabel: "Livraisons actives",
    ...
    branchInventoryTitle: "Inventaire de la succursale",
    currentStockFor: "Niveaux de stock pour",
    addNewProductTitle: "Ajouter un nouveau produit",
    productNamePlaceholder: "Nom du produit",
    pricePlaceholder: "Prix (RWF)",
    categoryPlaceholder: "Catégorie (par ex. Produits alimentaires)",
    unitPlaceholder: "Unité (ex. Pcs, Kg)",
    locationPlaceholder: "Emplacement (ex. Entrepôt Kigali, Allée 3)",
    imagePlaceholder: "URL de l'image",
    uploadImageNote: "Téléchargez l'image sur un service cloud, puis collez le lien public ici.",
    addingProduct: "Ajout en cours...",
    addProduct: "Ajouter le produit",
    ordersCountLabel_singular: "commande",
    // Profile / Tracker / Cart (FR)
    ...
    noLocationSelected: "Aucune position sélectionnée pour le moment.",
    trackingOrder: "Suivi de la commande",
    completeLabel: "Terminé",
    // Market rep (FR)
    marketRepTitle: "Représentant du marché",
  ...
  rw: {
    ...
    preparing: "Gutegura",
    ready: "Yiteguye",
    // Admin / Delivery / Market labels (RW)
    deliveryPortalTitle: "Aho kohereza ibicuruzwa",
    refresh: "Sana",
    logout: "Sohoka",
    totalLabel: "Igiteranyo",
    pendingLabel: "Birindimo",
    assignedLabel: "Byahawe",
    deliveringLabel: "Biri mu nzira",
    deliveredLabel: "Byatanzwe",
    ordersToDeliver: "Amategeko yo gutanga",
    loading: "Birimo gushyirwaho...",
    ordersCountLabel: "amategeko",
    noDeliveryOrdersFound: "Nta mategeko yo kohereza yabonetse kuri uyu mutanga.",
    tableId: "ID",
    tableCustomer: "Umukiriya",
    tableAddress: "Aderesi",
    tableTotal: "Igiteranyo",
    tableStatus: "Imiterere",
    tableUpdate: "Guhindura",
    tableProvider: "Umutanga",
    tableOwner: "Uwatanze",
    tableDate: "Italiki",
    ordersTab: "Amategeko",
    usersTab: "Abakoresha",
    inventoryTab: "Ububiko",
    totalOrdersLabel: "Umubare w'amategeko",
    activeDeliveriesLabel: "Ibyoherejwe biriho",
    customersLabel: "Abakiliya",
    recentOrders: "Amategeko aheruka",
    noUsersFound: "Nta bakoresha babonetse.",
    customersTitle: "Abakiliya",
    nameLabel: "Amazina",
    phoneLabel: "Telefone",
    addressLabel: "Aderesi",
    lastOrderLabel: "Italiki y'itegeko rya nyuma",
    unknownLabel: "Ntibizi",
    branchInventoryTitle: "Ububiko bwa Shami",
    currentStockFor: "Urutonde rw'ibicuruzwa kuri",
    addNewProductTitle: "Ongeramo igicuruzwa gishya",
    productNamePlaceholder: "Izina ry'igicuruzwa",
    pricePlaceholder: "Igiciro (RWF)",
    categoryPlaceholder: "Icyiciro (nka Food Products)",
    unitPlaceholder: "Igipimo (nka Pcs, Kg)",
    locationPlaceholder: "Aho giherereye (nka Kigali Warehouse, Aisle 3)",
    imagePlaceholder: "URL y'ifoto",
    uploadImageNote: "Shyira ifoto kuri cloud ubundi ushyire hano link yayo.",
    addingProduct: "Ongeramo...",
    addProduct: "Ongeraho igicuruzwa",
    ordersCountLabel_singular: "itegeko",
    // Profile / Tracker / Cart (RW)
    loadingProfile: "Gutegereza umwirondoro...",
    profileNotFound: "Umwirondoro ntiwabonywe.",
    myProfile: "Umwirondoro wanjye",
    memberSinceLabel: "Yitabiriye kuva:",
    noOrdersYet: "Nta mategeko kugeza ubu.",
    trackOrder: "Kurikira itegeko",
    noLocationSelected: "Nta hantu hahariho hakiriho.",
    trackingOrder: "Kurikira Itegeko",
    completeLabel: "Byuzuye",
    // Market rep (RW)
    marketRepTitle: "Uhagarariye isoko",
    incomingOrders: "Amategeko ari bugere",
